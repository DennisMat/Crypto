...
const provider = new Web3.providers.HttpProvider(config.providerUrl);

var web3 = new Web3(provider);

//var fromAddress = "0xf60c2Ea62EDBfE808163751DD0d8693DCb30019c";
var fromAddress = config.payerAccountTest;
...
async function getExpectedReturn() {
  ...
  let res=await OneSplitContract.methods.getExpectedReturn(fromTokenAddress,  toTokenAddress, amountToSwap,  100,      0    ).call();
...
async function approveSpender() {
  await DaiContract.methods.approve(oneSplitAddress, amountToSwap)
