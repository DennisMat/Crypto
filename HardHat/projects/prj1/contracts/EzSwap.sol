...
contract EzSwap {
    ...
    function swapExactETHForTokens(address token, uint amountOutMin) external payable {
        ...
        uniswap.swapExactETHForTokens{value: msg.value}(amountOutMin, path, msg.sender, deadline);
    }
