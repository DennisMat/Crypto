...
contract TokenSwap {
    ...
    //abiaddress private constant UNISWAP_V2_ROUTER =         0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // mainnet

    //though listed on the official uniswap website it does not work
    //address private constant UNISWAP_V2_ROUTER = 0x53544492C78D478294B5b1Fb8059a5D6C9aBBC67;//sepolia,


//This address seems to recive a lot of legit calls.
    //address private constant UNISWAP_V2_ROUTER =0xfFf9976782d46CC05630D1f6eBAb18b2324d6B14; //sepolia,
    ...
    */
    function buyTokensWithETHMoreGas(
        address UNISWAP_V2_ROUTER, address tokenSourceAddress,
    ...
    function recieveETHForTokensFullVersion(address UNISWAP_V2_ROUTER, address tokenSourceAddress,  uint tokenAmountIn, uint ethAmountOutMin) public {
        console.log("in recieveETHForTokensFullVersion");
        IUniswapV2Router02 uniswapRouter = IUniswapV2Router02(UNISWAP_V2_ROUTER);
        
        uint256 deadline = block.timestamp + 150; // Using 'now' for convenience, for a deadline of 15 seconds

        IERC20(tokenSourceAddress).approve(UNISWAP_V2_ROUTER, tokenAmountIn);
        address[] memory path = new address[](2);
